            ...
            <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
              ...
              <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-books">
                ...
                <div class="gallery-info">
                  ...
                  <a href="assets/img/departments-1.jpg" title="Branding 1" data-gallery="gallery-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
              ...
              <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-app">
                ...
                <div class="gallery-info">
                  <h4>App 2</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
                  <a href="assets/img/departments-2.jpg" title="App 2" data-gallery="gallery-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="gallery-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div><!-- End gallery Item -->
              ...
              <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-product">
                ...
                <div class="gallery-info">
                  <h4>Product 2</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
                  <a href="assets/img/departments-3.jpg" title="Product 2" data-gallery="gallery-gallery-product" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="gallery-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div><!-- End gallery Item -->
              ...
              <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-branding">
                ...
                <div class="gallery-info">
                  <h4>Branding 2</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
                  <a href="assets/img/departments-4.jpg" title="Branding 2" data-gallery="gallery-gallery-branding" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="gallery-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div><!-- End gallery Item -->
              ...
              <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-books">
                ...
                <div class="gallery-info">
                  <h4>Books 2</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
                  <a href="assets/img/departments-1.jpg" title="Branding 2" data-gallery="gallery-gallery-book" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="gallery-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div><!-- End gallery Item -->
              ...
              <div class="col-lg-4 col-md-6 gallery-item isotope-item filter-app">
                ...
                <div class="gallery-info">
                  <h4>App 3</h4>
                  <p>Lorem ipsum, dolor sit amet consectetur</p>
                  <a href="assets/img/departments-2.jpg" title="App 3" data-gallery="gallery-gallery-app" class="glightbox preview-link"><i class="bi bi-zoom-in"></i></a>
                  <a href="gallery-details.html" title="More Details" class="details-link"><i class="bi bi-link-45deg"></i></a>
                </div>
              </div><!-- End gallery Item -->
